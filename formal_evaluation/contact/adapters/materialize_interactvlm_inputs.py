...
def main() -> None:
    ...
    parser.add_argument(
        "--window-input-index", type=Path, action="append", required=True,
        help="completed input index; repeat to build one globally deduplicated manifest",
    )
    ...
    for index_path in args.window_input_index:
